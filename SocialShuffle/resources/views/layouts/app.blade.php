    ...
    <body class="bg-gray-100 font-sans leading-normal tracking-normal flex flex-col min-h-full">
            ...
            <div class="mx-auto max-w-10xl px-2 sm:px-6 lg:px-8">
                <div class="relative flex h-16 items-center justify-between">
                    ...
                    <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <a href="{{ route('team.index') }}" class="flex flex-shrink-0 items-center justify-center">
                            <img class=" h-10 w-auto mr-4" src="{{ asset('SocialShuffleLogo.png') }}" alt="App Logo">
                            <h1 class="text-white text-lg hidden sm:block">SocialShuffle</h1>
                        </a>
                    ...
                    <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">            
                        ...
                        <div class="relative ml-3">
                            @auth
                                <button type="button" class="relative flex rounded-full bg-gray-800 text-sm px-2 py-1 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" 
                            ...
                            @guest
                                <a href="{{ route('auth.login') }}"
                                    class=" text-white bg-blue-500 p-2 rounded hover:bg-blue-400">
                                    Se connecter
                                </a>
                            @endguest
                            ...
                            <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none hidden" 
                                ...
                                <a href="{{ route('auth.logout') }}" class="block px-4 py-2 text-sm text-red-500" role="menuitem" tabindex="-1" id="user-menu-item-2">Se déconnecter</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <footer class="bg-gray-800 p-4 rounded-t-3xl">
            <div class="container mx-auto text-center text-white">
                ETML - TPI - SocialShuffle - Samuel Dos Santos - 2024
            </div>
        </footer>
    </body>
</html>
